...
def process_line(
    ...
    _, norm_text, phones, tones, word2ph, _, _, _ = clean_text_with_given_phone_tone(
        text=text,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_multiringual", action="store_true")
    ...
    use_multiringual: bool = args.use_multiringual
