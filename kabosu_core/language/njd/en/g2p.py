...
from kabosu_core.language.njd.en.expand import normalize_numbers
...
from kabosu_core.asseets import NLTK_DIR, G2P_EN_DIR
...
class G2p(object):
    ...
    def load_variables(self):
        self.variables = np.load( str(G2P_EN_DIR / 'checkpoint20.npz'))
