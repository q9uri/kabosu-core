...
from kabosu_core.llm.rag.lightrag.api.utils_api import display_splash_screen, check_env_file
...
from kabosu_core.llm.rag.lightrag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from kabosu_core.llm.rag.lightrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from kabosu_core.llm.rag.lightrag.api.lightrag_server import get_application
